...
public class VocabularyDeserializer implements JsonDeserializer<VocabularyObject> {

    @Override
    public VocabularyObject deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
        ...
        final VocabularyObject vocabularyObject = new VocabularyObject();
        vocabularyObject.setId(id);
        vocabularyObject.setName(name);
        vocabularyObject.setData(subObjects);
