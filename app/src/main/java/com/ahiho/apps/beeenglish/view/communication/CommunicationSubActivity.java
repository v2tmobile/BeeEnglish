...
public class CommunicationSubActivity extends AppCompatActivity {
    ...
    private void loadData(int id) {
        ...
        List<CommunicationSubObject> objects = new ArrayList<>();
        try{
        ...
        if(objects.size()>0){
            rvData.setAdapter(new RecyclerCommunicationSubListAdapter(objects,id));
        }else{
